...
const DetailFrame: FC<{DBObject: DBObject, setDBObject: Function, url: string, setErrorMsg: Function, mode:DetailFrameMode, hideObjectManager: MouseEventHandler<HTMLInputElement>, formSubmitted: FormEventHandler<HTMLFormElement>}>= (props) => {
    return (
        <div>
