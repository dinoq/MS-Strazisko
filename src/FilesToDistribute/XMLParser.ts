import { getEmptyValues } from "../features/data/definitions/values-definitions";
...
import * as ValuesDefinitions from "../features/data/definitions/values-definitions";
        ...
        forms.forEach((form) => {
            ...
            for (const XMLcomponent of XMLLFComponents) {
                let component: LFComponentDef = {
                    attributeKey: "",
                    componentType: mapToComponentType(
