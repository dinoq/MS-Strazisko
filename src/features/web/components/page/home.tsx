...
const Home: FC<HomeProps>  = ({
    ...
    const [introText, setIntroText] = useState<{ title: string, content: string }>({ title: "", content: "" });
    const [features, setFeatures] = useState<Array<{ icon: any, bgColor: string, alt: string, title: string, description: string }>>([]);
    const [teachers, setTeachers] = useState<Array<{ imgSrc: string, name: string, job: string }>>([]);
    const [events, setEvents] = useState<Array<{ imgSrc: string, title: string, date: string, description: string }>>([]);
    const [publicImages, setPublicImages] = useState<Array<{ original: string, thumbnail: string }>>([]);
